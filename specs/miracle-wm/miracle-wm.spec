...
#   https://src.fedoraproject.org/rpms/miracle-wm/raw/rawhide/f/miracle-wm.spec
# Adapted 2026-09-24. Not branched to epel9/epel10 (404 on both). Depends on `mir` (specs/mir/,
# also forked from Fedora rawhide the same way) plus `gtk4-layer-shell-0` (already built earlier
# this session for ghostty, specs/gtk4-layer-shell/). Every other BuildRequires confirmed present
# on el10 in a full dependency sweep before forking.
# No changes needed vs. upstream Fedora spec (no %%autorelease/%%evr issues, static Release already).
# STATUS: not yet mock-built - depends on `mir` building successfully first.
# ---------------------------------------------------------------------------
...
* Thu Sep 04 2025 Neal Gompa <ngompa@fedoraproject.org> - 0.7.0-1
- Update to 0.7.0

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.6.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Thu Jul 17 2025 Neal Gompa <ngompa@fedoraproject.org> - 0.6.2-1
- Update to 0.6.2
...
* Sat Jan 18 2025 Neal Gompa <ngompa@fedoraproject.org> - 0.4.1-1
- Update to 0.4.1

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.4.0-2
